...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $mail->Body    = "Prix : ".substr($_POST['price'], 0, 3)." €<br>Nom : ".$_POST['name']."<br>Email : ".$_POST['email']."<br>T&eacute;l&eacute;phone : ".$_POST['tel'];
  $mail->AltBody = "Prix : ".substr($_POST['price'], 0, 3)." €<br>Nom : ".$_POST['name']."<br>Email : ".$_POST['email']."<br>T&eacute;l&eacute;phone : ".$_POST['tel'];
